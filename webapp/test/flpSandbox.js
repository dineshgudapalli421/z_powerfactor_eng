		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Power Factor Validation - Engineering",
									"targetURL": "#comsaplhmrzpowerfactoreng-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzpowerfactoreng-display": {
								"semanticObject": "comsaplhmrzpowerfactoreng",
								"action": "display",
								"description": "Power Factor Validation - Engineering",
								"title": "Power Factor Validation - Engineering",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zpowerfactoreng",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zpowerfactoreng")
								}
							}
						}
					}
